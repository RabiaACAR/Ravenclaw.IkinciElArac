...
namespace Ravenclaw.IkinciElArac.DataAccess.Mapping
{
    public class KurumsalMusteriMapping
    {
        ...
        public List<KurumsalMusteriListeleVM> KurumsalMusterileriGetir()
        {
            using (IkinciElAracEntities db = new IkinciElAracEntities())
            {
                getirilecekKurumsalMusteriler = (from k in db.KurumsalKullanicis
                                                 ...
                                                 join ilce in db.ilces on k.ilID equals ilce.ilID  where m.AktifMi == false
                                                 select new
                                                 {
                                                     AdSoyad = k.AdSoyad,
                                                     FirmaAdi = k.FirmaAdi,
